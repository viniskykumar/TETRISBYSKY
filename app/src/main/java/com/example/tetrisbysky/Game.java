package com.example.tetrisbysky;
...
public class Game extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        difficultyToggle.setId(R.id.difficultyToggle);
        ...
        View speedButtonListener = findViewById(R.id.difficultyToggle);
    ...
    public void onClick(View action) {
        if (action == left) {
            ...
            if (!gameState.difficultMode) {
                ...
                delay = delay * delayFactor;
                difficultyToggle.setText("dificult");
